...
# Remember to replace this line to Github directory
source("C:/Users/idanilevicz/Documents/Ian/Computo/Computo_1/R/functions3.R")
```
...
set.seed(2025)
sim_surv1 =  sim_surv_c(lambda1, n, M, eta, ncomp=2, nfold, maxt)   # lambda 1 and c-index
sim_surv2 =  sim_surv_c(lambda2, n, M, eta, ncomp=2, nfold, maxt)   # lambda 2 and c-index  

set.seed(2025)
sim_surv3 =  sim_surv_aic(lambda1, n, M, eta, ncomp=2, nfold, maxt) # lambda 1 and AIC  
sim_surv4 =  sim_surv_aic(lambda2, n, M, eta, ncomp=2, nfold, maxt) # lambda 2 and AIC
...
ggplot(df_long, aes(x = factor(Eta), y = N_features, fill = Lambda)) +
  ...
  labs(
    ...
    title = "Selected features by η and λ"
  ) +
  theme_minimal() +
...
# Add title
final_plot <- ggdraw() +
  draw_label("Frequency of eta with the highest C-index by k and lambda", fontface = "bold", size = 16, y = 0.98, hjust = 0.5) +
...
# Add title
final_plot <- ggdraw() +
  draw_label("Frequency of eta with the lowest AIC by k and lambda", fontface = "bold", size = 16, y = 0.98, hjust = 0.5) +
  draw_plot(combined, y = 0, height = 0.95)
...
<!--path comment: C:/Users/i_danilevicz/Documents/Computo/Computo_1/ -->

::: {.figure #fig-cv-plots}

<div style="display: flex; gap: 1em;">
  <img src="figures/cv1.png" width="45%">
  <img src="figures/cv2.png" width="45%">
</div>
...
<div style="display: flex; gap: 1em;">
  <img src="figures/boot1.png" width="45%">
  <img src="figures/boot2.png" width="45%">
</div>
